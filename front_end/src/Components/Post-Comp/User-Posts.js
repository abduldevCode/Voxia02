...
import kohli from '../../Assets/kohli.mp4'
import irfan from '../../Assets/irfan.mp4'
import { UserContext } from '../../Context/UserContext';
import v01 from '../../Assets/furqan.mp4'
...
import VideoPlayer from '../MediaPlayer/V';
    ...
    return (
        <div className="video-post-container">
            <div className="video-post-header">
                ...
                <p style={{ color: "#4a5568", paddingLeft: "5px", paddingRight: "5px" }}>
            ...
            <div className="video-container" onClick={togglePlay}>
                {isPlaying ? (
                    <video
                        ...
                        style={{ borderRadius: "8px", marginTop: "5px", padding: "1px", backgroundColor: "#f0f0f0", height: "auto", maxHeight: "500px", objectFit: "cover" }} // Optional: Add some styling
                    >
                        <source src={v01} type="video/mp4" />
            ...
            <div className="post-footer"  >
                <button className="like-btn"><IoIosHeartEmpty /> <span>Likes</span></button>
                <button className="comment-btn"> <span>Comments</span></button>
                <button className="share-btn"><IoMdShareAlt /><span>Share</span></button>
            </div>
...
const UserPosts = ({ id }) => {
    ...
    const { GetPosts, posts, userPosts, GetUserPosts, setPostToEdit, loadPost, HandleLike, fetchComment, loadComt, commentList, createComment, setCommentList } = useContext(PostContext);
                ...
                loadPost ?
                    ...
                    (<>
                        <div style={{
                            ...
                            <p style={{fontSize:"20px", color:"grey"}}>No Post </p>
                        </div>
